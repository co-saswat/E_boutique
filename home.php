          ...
          <div id="slider-carousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
              <div class="item active">
                <div class="col-sm-6">
                  <h1><span>FASHI</span>OP</h1>
                  <h2>At Affordable Price</h2>
                  <p>All the right stuff, for all the right people<br> Be exclusive. Be Divine. Be yourself. </p>
              ...
              <div class="item">
                <div class="col-sm-6">
                  <h1><span>FASHI</span>OP</h1>
                  <h2>Free Shirt in Shopping Above 5000</h2>
                   <p>All the right stuff, for all the right people<br> Be exclusive. Be Divine. Be yourself. </p>
              ...
              <div class="product-image-wrapper">
                <div class="single-products">
                    <div class="productinfo text-center">
                      ...
                      <h2>&#x20B9 <?php  echo $result->PRODISPRICE; ?></h2>
