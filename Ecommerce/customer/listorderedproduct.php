  ...
  <div class="modal-content">
	<div class="modal-header">
		...
		<table>
			<tr>
				<td align="center"> 
				<img src="<?php echo web_root; ?>images/home/mainlogo.png"   alt="Image">
        		</td> 
			</tr>
		</table>
...
<?php  
}elseif ($cur->PAYMENTMETHOD=="Card"){
		 
?>
 	 <h4>Your order has been confirmed and delivered</h4><br/>
 		<h5>DEAR Ma'am/Sir ,</h5>
		<h5>Your order is on its way! As you have ordered via Card , so Sufficient Amount will Deducted from Amount.</h5>
		 <hr/>
		 <h4><strong>Delivery Information</strong></h4>
		 <div class="row">
		 	<div class="col-md-6">
...
<?php 
}elseif ($cur->PAYMENTMETHOD=="UPI"){
		 
?>
 	 <h4>Your order has been confirmed and delivered</h4><br/>
 		<h5>DEAR Ma'am/Sir ,</h5>
		<h5>Your order is on its way! As you have ordered via UPI Account , so Sufficient Amount will Deducted from Amount .	</h5>
		 <hr/>
		 <h4><strong>Delivery Information</strong></h4>
		 <div class="row">
		 	<div class="col-md-6">
				 ...
				 $subtot=0;
				  $query = "SELECT * 
						...
						echo '<tr>';  
				  		...
				  		echo '<td> &#x20B9 '. number_format($result->PROPRICE,2).' </td>';
				  		echo '<td align="center" >'. $result->ORDEREDQTY.'</td>';
				  		?>
				  		 <td> &#x20B9 <output><?php echo  number_format($result->ORDEREDPRICE,2); ?></output></td> 
				  		<?php
		...
		?>
 		...
 		<div class="row">
		  	...
		  	<div class="col-md-6 pull-right">
		  		<p align="right">Total Price : &#x20B9 <?php echo number_format($subtot,2);?></p>
		  		<p align="right">Delivery Fee : &#x20B9 <?php echo number_format($price,2); ?></p>
		  		<p align="right">Overall Price : &#x20B9 <?php echo number_format($cur->PAYMENT,2); ?></p>
		  	</div>
		  </div>
		  ...
		  <div class="row">
		  	  ...
		  	  <p>Sincerely.</p>
		  	  <h4><a href="index.php">FASHIOP</a></h4>
		  </div>
		  <?php }?>
  </div> 
