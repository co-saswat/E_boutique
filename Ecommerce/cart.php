...
?>
             ...
             ';
                                  ...
                                  &#x20B9  <?php echo  $result->PRODISPRICE ; ?>
                                  </td>
                                  <td class="input-group custom-search-form" >
                                     ...
                                     <td> &#x20B9 <output id="Osubtot<?php echo $result->PROID ?>"><?php echo   $_SESSION['gcCart'][$i]['price'] ; ?></output></td>
                                </tr>
                        ...
                        <h3 align="right"> Total  &#x20B9<span id="sum">0</span></h3> 
    </div>
  </div>  
