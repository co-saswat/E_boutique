  ...
  <?php check_message(); ?>
      <div class="">
        <div class="panel panel-default">
          ...
          <div>Every products has a mininum price of &#x20B9 50.00 each to be able to order.</div>
      <div class="table-responsive">
       <div  class="fixnmix_scroll_carttwo" >
         ...
         <tbody > 
            ...
            ?>
                      <tr>
                        ...
                        <td>&#x20B9 <?php echo number_format($result->PRICE,2) ?></td>
                        ...
                        <td>&#x20B9 <output id="Osubtot<?php echo $result->PRODUCTID ?>"><?php echo   $_SESSION['fixnmix_cart'][$i]['price'] ; ?></output>
        ...
        ?>
                  ...
                  <table  >
                  <tfoot >
                     <strong><h1 align="right">Total Price : &#x20B9 <span style="margin-right:3%"  id="sum">0.00</span></h1></strong></td>
                  ...
                  <div class="form-group">
                   ...
                   <div class="form-group">
                    ...
                    <!-- <input type="checkbox" name="condition" value="checkbox" /> -->
                      <small>Agree the <a class="toggle-modal"  onclick=" OpenPopupCenter('terms.php','Terms And Codition','600','600')"  ><b>TERMS AND CONDITION</b></a> of this Boutique Shop</small>
